...
function Header() {
    ...
    return (
        <>
        <header className="w-full h-[90px] flex justify-between items-center">
            <button className="w-max h-max backdrop-blur-2xl bg-white/20 rounded-2xl p-2 text-white flex justify-center items-center gap-2 cursor-pointer" onClick={handleCity}>
                ...
                <h2 className="pr-1 font-extrabold font-poppins text-2xl">{data && data.resolvedAddress}</h2>
            </button>
            <button className="text-white cursor-pointer w-max h-max" onClick={handleGithub}>
