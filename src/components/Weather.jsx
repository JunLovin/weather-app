...
function Weather(){
    ...
    return (
        <>
        <div className="flex justify-around w-[1200px] h-[300px] mt-8">
            <div className="conditions-container flex flex-col justify-between w-max">
                <div className="conditions">
                    <h2 className="text-6xl font-bold text-white mb-2">{data && data.currentConditions.conditions}</h2>
                    <h3 className="text-2xl font-bold text-white w-[80%]">{data && data.description}</h3>
                </div>
