...
function SearchInput() {
    ...
    return (
        ...
        <input type="text" id="main-input" value={input} onChange={handleInput} onKeyDown={handleEnter} className="rounded-2xl w-[500px] max-[33.125rem]:w-full h-[60px] outline-none backdrop-blur-2xl bg-white/10 font-semibold text-xl pr-12 pl-5" />
